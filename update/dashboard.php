...
<head>
    ...
    <style>
        ...
        .sidebar { 
            height: 100vh; 
            background: rgba(15, 32, 39, 0.85); /* Slightly clearer for readability */
        ...
        ::-webkit-scrollbar-thumb { background: #3a4b55; border-radius: 4px; }
        ...
        <div class="row g-4 mb-5">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="glass-card p-4 h-100 animate-up delay-1">
                    ...
                    <div class="mt-4 pt-3 border-top border-white border-opacity-10 d-flex align-items-center small text-success">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="glass-card p-4 h-100 animate-up delay-2">
                    ...
                    <div class="mt-4 pt-3 border-top border-white border-opacity-10 d-flex align-items-center small text-info">
                        <i class="bi bi-clock me-2"></i> <span>Latest: <?php echo !empty($versions) ? $versions[0] : '-'; ?></span>
                    </div>
                </div>
            </div>
             ...
             <div class="col-md-6 col-lg-4">
                <div class="glass-card p-4 h-100 animate-up delay-3">
                    <div class="d-flex justify-content-between align-items-start">
                     ...
                     <div class="mt-4 pt-3 border-top border-white border-opacity-10 d-flex align-items-center small text-muted">
                ...
                <div class="glass-card h-100 animate-up delay-1">
                    ...
                    <div class="table-responsive">
                        <table class="table table-custom w-100">
                            ...
                            <tbody>
                                <?php if(empty($dbLogs)): ?>
                                    <tr><td colspan="4" class="text-center text-muted py-5">No sync activity recorded yet.</td></tr>
                                <?php else: ?>
                                    <?php foreach($dbLogs as $log): ?>
                                    <tr>
                                        <td class="text-nowrap text-muted small"><i class="bi bi-clock me-2"></i><?php echo date('H:i, d M', strtotime($log['created_at'])); ?></td>
                                        <td class="fw-medium text-warning"><?php echo htmlspecialchars($log['server_name']); ?></td>
                                        <td>
                                        ...
                                        <td class="text-capitalize small"><?php echo htmlspecialchars($log['sync_type']); ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </tbody>
                                ...
                                <?php foreach(array_slice($versions, 0, 7) as $ver): ?>
                                    <li class="d-flex align-items-center mb-3">
                                        <div class="me-3 d-flex flex-column align-items-center">
                                            <div class="rounded-circle bg-success bg-opacity-25 p-1 border border-success border-opacity-50">
