...
<div class="row">
    ...
    <div class="col-lg-2 col-6">
        <div class="small-box bg-gradient-lightblue">
            ...
            <a href="?page=suratmasuk" class="small-box-footer">More info <i class="bi bi-link-45deg"></i></a>
        </div>
    </div>
    ...
    <div class="col-lg-2 col-6">
        <div class="small-box bg-gradient-success">
            ...
            <div class="icon"><i class="ion ion-stats-bars"></i></div>
            <a href="?page=suratkeluar" class="small-box-footer">More info <i class="bi bi-link-45deg"></i></a>
        </div>
    </div>
    ...
    <div class="col-lg-2 col-6">
        <div class="small-box bg-gradient-danger">
            ...
            <div class="icon"><i class="ion ion-stats-bars"></i></div>
            <a href="?page=suratkeputusan" class="small-box-footer">More info <i class="bi bi-link-45deg"></i></a>
        </div>
    </div>
    ...
    <div class="col-lg-2 col-6">
        <div class="small-box bg-gradient-warning">
            ...
            <div class="icon"><i class="ion ion-stats-bars"></i></div>
            <a href="?page=suratedaran" class="small-box-footer">More info <i class="bi bi-link-45deg"></i></a>
        </div>
    </div>
</div>
<!-- /.row -->
                ...
                <div class="card">
                    <div class="card-header bg-menu-gradient">
                        ...
                        <div class="card-tools">
                            ...
                            <select id="chart-year-filter" class="form-select form-select-sm me-2" style="width: 100px; display: inline-block;">
                                <?php
                    ...
                    <div class="card-body">
                        <div class="chart">
                            <canvas id="letterStatisticsChart" style="min-height: 300px; height: 300px; max-height: 300px; max-width: 100%;"></canvas>
                        </div>
                    </div>
                </div>
                <!-- /.card -->
                    ...
                    <div class="card card-outline primary shadow-lg border-0" style="border-radius: 15px;">
                        <div class="card-body box-profile text-center py-4">
                            ...
                            <div class="text-center mb-3">
                                <img class="profile-user-img img-fluid img-circle shadow-sm" src="<?php echo $foto_peg; ?>" alt="User profile picture" style="width: 150px; height: 150px; object-fit: cover; border: 5px solid #fff;">
                            </div>
                            <h3 class="profile-username text-center fw-bold text-primary mb-0"><?php echo $pegawai['nm_pegawai'] ?? $nuser; ?></h3>
                            <p class="text-muted text-center small mb-3"><?php echo $pegawai['nip'] ?? 'NIP tidak tersedia'; ?></p>
                            <div class="badge bg-soft-primary px-3 py-2 mb-4" style="background-color: #e7f1ff; color: #0d6efd; border-radius: 10px;">
                                <?php echo $pegawai['jabatan'] ?? 'Jabatan tidak tersedia'; ?>
                            </div>

                            <ul class="list-group list-group-unbordered mb-3 text-start px-2">
                                <li class="list-group-item border-0 border-bottom">
                                    <small class="text-muted text-uppercase d-block fw-bold" style="font-size: 0.7rem;">Pangkat / Golongan</small>
                                    <span class="fw-bold"><?php echo ($pegawai['pangkat'] ?? '-') . ' / ' . ($pegawai['golongan'] ?? '-'); ?></span>
                                </li>
                                <li class="list-group-item border-0 border-bottom">
                                    <small class="text-muted text-uppercase d-block fw-bold" style="font-size: 0.7rem;">Unit Kerja</small>
                                    <span class="fw-bold"><?php echo $pegawai['unit_kerja'] ?? '-'; ?></span>
                                </li>
                                <li class="list-group-item border-0">
                                    <small class="text-muted text-uppercase d-block fw-bold" style="font-size: 0.7rem;">Status Kepegawaian</small>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-12 mb-4">
                            <div class="card bg-menu-gradient text-white shadow-lg border-0" style="border-radius: 15px; overflow: hidden;">
                                <div class="card-body p-4 position-relative">
                                    <div class="position-relative z-index-1">
                                        <h2 class="fw-bold">Selamat Datang, <?php echo explode(' ', $pegawai['nm_pegawai'] ?? $nuser)[0]; ?>!</h2>
                                        <p class="mb-0 opacity-75">Ini adalah dashboard sistem kepegawaian pribadi Anda. Anda dapat melihat data profil dan status kepegawaian Anda di sini.</p>
                                    </div>
                                    <i class="fas fa-user-check position-absolute" style="right: -20px; bottom: -20px; font-size: 150px; opacity: 0.1;"></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card shadow-sm border-0 h-100" style="border-radius: 12px;">
                                <div class="card-header bg-white border-0 pt-3">
                                    <h5 class="card-title fw-bold text-muted small text-uppercase"><i class="fas fa-info-circle me-2"></i> Detail Informasi</h5>
                                </div>
                                <div class="card-body pt-0">
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <div class="d-flex align-items-center p-2 bg-light rounded-3">
                                                <div class="bg-white p-2 rounded-circle shadow-sm me-3"><i class="fas fa-map-marker-alt text-danger"></i></div>
                                                <div>
                                                    <small class="text-muted d-block" style="font-size: 0.7rem;">Tempat, Tgl Lahir</small>
                                                    <span class="fw-bold small"><?php echo ($pegawai['tempat_lahir'] ?? '-') . ', ' . ($pegawai['tgl_lahir'] ?? '-'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-flex align-items-center p-2 bg-light rounded-3">
                                                <div class="bg-white p-2 rounded-circle shadow-sm me-3"><i class="fas fa-graduation-cap text-primary"></i></div>
                                                <div>
                                                    <small class="text-muted d-block" style="font-size: 0.7rem;">Pendidikan</small>
                                                    <span class="fw-bold small"><?php echo $pegawai['pendidikan'] ?? '-'; ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card shadow-sm border-0 h-100" style="border-radius: 12px;">
                                <div class="card-header bg-white border-0 pt-3">
                                    <h5 class="card-title fw-bold text-muted small text-uppercase"><i class="fas fa-address-book me-2"></i> Kontak Saya</h5>
                                </div>
                                <div class="card-body pt-0">
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <div class="d-flex align-items-center p-2 bg-light rounded-3">
                                                <div class="bg-white p-2 rounded-circle shadow-sm me-3"><i class="fas fa-phone-alt text-success"></i></div>
                                                <div>
                                                    <small class="text-muted d-block" style="font-size: 0.7rem;">No. HP / WhatsApp</small>
                                                    <span class="fw-bold small"><?php echo $pegawai['no_hp'] ?? '-'; ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-flex align-items-center p-2 bg-light rounded-3">
                                                <div class="bg-white p-2 rounded-circle shadow-sm me-3"><i class="fas fa-envelope text-warning"></i></div>
                                                <div>
                                                    <small class="text-muted d-block" style="font-size: 0.7rem;">Email</small>
                                                    <span class="fw-bold small"><?php echo $pegawai['email'] ?? '-'; ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
