                ...
                <div class="col-md-6">
                    <div class="card card-success card-outline bg-dark-lighter shadow-sm" style="border-radius: 15px;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-4 text-center p-5 border border-2 border-dashed border-secondary rounded-3" id="dropZone">
                                ...
                                <button type="button" class="btn btn-success px-4 rounded-pill fw-bold" onclick="document.getElementById('excelFile').click()">
                                    Pilih File Excel
                                </button>
                            </div>
                            ...
                            <div id="fileInfo" class="d-none alert alert-dark bg-dark-darker border-secondary">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span><i class="fas fa-file-excel me-2 text-success"></i> <strong id="fileName">file.xlsx</strong></span>
                                    <button type="button" class="btn btn-sm btn-danger rounded-circle" onclick="resetFile()"><i class="fas fa-times"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer bg-transparent border-0 pb-4 text-center">
                            <button type="button" id="btnImport" class="btn btn-primary px-5 rounded-pill fw-bold" disabled onclick="startImport()">
                    ...
                    <div id="progressCard" class="card bg-dark-lighter shadow-sm d-none" style="border-radius: 15px;">
                        <div class="card-body py-4">
                            <h6 class="fw-bold mb-3">Memproses Data... <span id="progressPercent" class="float-end">0%</span></h6>
                    ...
                    <div class="card bg-dark-lighter shadow-sm" style="border-radius: 15px;">
                        ...
                        <div class="card-body">
                            <table class="table table-sm table-dark bg-transparent">
                                ...
                                <tbody>
                                    <tr><td>A</td><td>NIP (Tanpa Spasi)</td><td>Ya</td></tr>
                                    <tr><td>B</td><td>Nama Pegawai / Guru</td><td>Ya</td></tr>
                                    <tr><td>C</td><td>Jabatan</td><td>Tidak</td></tr>
                                    <tr><td>D</td><td>Status (PNS/Honorer)</td><td>Tidak</td></tr>
                                    <tr><td>E</td><td>Unit Kerja</td><td>Tidak</td></tr>
                                </tbody>
                            </table>
                            <div class="alert alert-warning bg-warning-subtle border-0 text-warning-emphasis small mt-3">
                                <i class="fas fa-exclamation-triangle me-2"></i>
                                <strong>Penting:</strong> Baris pertama (Header) harus ada dan akan diabaikan oleh sistem.
                            </div>
                                <button type="button" onclick="downloadTemplate()" class="btn btn-outline-info btn-sm rounded-pill w-100 mt-2 fw-bold">
...
function downloadTemplate() {
    const header = [["NIP", "Nama Pegawai", "Jabatan", "Status (PNS/Honorer)", "Unit Kerja"]];
...
<style>
    .bg-dark-lighter { background-color: #1e293b !important; }
    .bg-dark-darker { background-color: #0f172a !important; }
