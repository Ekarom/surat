            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-header bg-menu-gradient">
                        ...
                        <h3 class="card-title text-white">Data Identitas Sekolah
                        </h3>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group"><label>Kelurahan</label><input type="text"
                                            class="form-control" name="nkel"
                                            value="<?= isset($data['kelurahan']) ? $data['kelurahan'] : '' ?>"></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group"><label>Kecamatan</label><input type="text"
                                            class="form-control" name="nkec"
                                            value="<?= isset($data['kecamatan']) ? $data['kecamatan'] : '' ?>"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group"><label>Kabupaten/Kota</label><input type="text"
                                            class="form-control" name="nkab"
                                            value="<?= isset($data['kabupaten']) ? $data['kabupaten'] : '' ?>"></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group"><label>Provinsi</label><input type="text"
                                            class="form-control" name="nprovinsi"
                ...
                <div class="card card-navy card-outline card-tabs">
                    ...
                    <div class="card-header bg-menu-gradient p-0 pt-1 border-bottom-0">
                        ...
                        <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link" id="tab-ktu" data-toggle="pill" href="#content-ktu"
                                    role="tab" style="color: #fff;">KTU</a></li>
...
<!-- Summernote: self-contained dynamic loader -->
<script>
    $(document).ready(function () {
        ...
        if (typeof $.fn.summernote !== 'undefined') {
            // Already available (loaded by the main layout)
            doInitSummernote();
        } else {
            // Load assets dynamically, then initialize
